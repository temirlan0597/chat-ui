    ...
    >
      ...
      <v-list flat>
        <v-list-item router to="/">
          <v-list-item-content>
            <v-icon class="mb-2" large color="grey">fas fa-file-alt</v-icon>
          </v-list-item-content>
        </v-list-item>
        <v-list-item router to="/">
          <v-list-item-content>
            <v-icon class="mb-2" large color="grey">fas fa-calendar-day</v-icon>
          </v-list-item-content>
        </v-list-item>
        <v-list-item router to="/">
          <v-list-item-content>
            <v-icon class="mb-2" large color="blue">fas fa-comment-alt</v-icon>
          </v-list-item-content>
        </v-list-item>
        <v-list-item router to="/">
          <v-badge color="blue" dot overlap>
            <v-list-item-content>
              <v-icon class="mb-2" large color="grey">fas fa-bell</v-icon>
            </v-list-item-content>
          </v-badge>
        </v-list-item>
      </v-list>
